...
export const registry: any[] = [
  ...guideRegistry, // 15
  { id: 'rouge-score', name: 'ROUGE Score', description: 'Mean of ROUGE-1, ROUGE-L, and ROUGE-2.', category: 'Technical Performance & Fluency', governancePriority: true, governanceCategory: 'Technical Performance & Fluency',
    implementation: (c: any, r: any) => {
       const r1 = rouge1(c, r) || 0;
       const rl = rougeL_guide(c, r) || 0;
       const r2 = rouge2(c, r) || 0;
       return (r1 + rl + r2) / 3.0;
    }, inputBuilder: buildGuideMetricInputs, type: 'row-level', higherIsBetter: true },
  { id: 'bleu-score', name: 'BLEU Score', description: 'Mean of BLEU (Guide) and BLEU-4.', category: 'Technical Performance & Fluency', governancePriority: true, governanceCategory: 'Technical Performance & Fluency',
    implementation: (c: any, r: any) => {
       const b1 = bleu(c, r) || 0;
       const b4res = calculateBLEU(c, r);
       const b4 = b4res?.f1 || 0;
       return (b1 + b4) / 2.0;
    }, inputBuilder: buildGuideMetricInputs, type: 'row-level', higherIsBetter: true },
  ...
  { governancePriority: true, governanceCategory: 'Governance & Readiness', id: 'transparency-score', name: 'Transparency Score', description: 'Weighted average of transparency factors.', category: 'Reasoning & Transparency', implementation: calculateTS, inputBuilder: () => buildGovernanceInputs(null), type: 'configuration', higherIsBetter: true
  },
