...
registryContent = registryContent.replace(
  /id: 'bias-mitigation'[\s\S]*?inputBuilder:\s*higherIsBetter: true, excludeFromVerdict: true, type: 'aggregate'/g,
...
registryContent = registryContent.replace(
  /id: 'bias-index'[\s\S]*?inputBuilder:\s*higherIsBetter: true, excludeFromVerdict: true, type: 'aggregate'/g,
...
registryContent = registryContent.replace(
  /id: 'privacy-integrity'[\s\S]*?inputBuilder:\s*higherIsBetter: true, excludeFromVerdict: true, type: 'aggregate'/g,
...
registryContent = registryContent.replace(
  /id: 'provenance-completeness'[\s\S]*?inputBuilder:\s*higherIsBetter: true, excludeFromVerdict: true, type: 'aggregate'/g,
...
registryContent = registryContent.replace(
  /id: 'auditability-level'[\s\S]*?inputBuilder:\s*higherIsBetter: true, excludeFromVerdict: true, type: 'aggregate'/g,
...
registryContent = registryContent.replace(
  /id: 'compliance-adaptability'[\s\S]*?inputBuilder:\s*higherIsBetter: true, excludeFromVerdict: true, type: 'aggregate'/g,
